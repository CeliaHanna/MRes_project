...
main_folder_path <- "/Users/user/Desktop/metadata_flow/SAPMER/sapmer_interpolated"
output_folder_path <- "/Users/user/Desktop/metadata_flow/SAPMER/sapmer_interpolated_processed"
